<div align="center"><h1>Seize</h1></div>
...
写在最前
我们打造 Seize 的初衷，源于一个普遍的生活观察：太多人渴望摆脱重复乏味的日常，满心欢喜定下年度目标，却终因拖延与三分钟热度，陷入 “定目标 — 半途而废 — 重新开始” 的循环。
于是，Seize 应运而生。这是一款现代化个人绩效评估工具，帮你清晰设定年度目标，实时跟踪任务进度，多维度评估绩效表现 —— 从年度到季度、再到月度的层级拆解，每一层目标都可自定义；评分规则严格锚定任务完成进度，就连公司里 “评级 D 要安排专项培训” 的小趣味也被我们保留（哈哈哈哈）。
它脱胎于公司现有的绩效考核工具，却不止于助力员工落地工作目标；更希望能陪你高效管理年度计划、持续提升个人状态，真正做到不浪费任何一天，Seize（把握） 属于自己的每一寸时光。
这款工具由两位周同事联合打造：实习生 PotatoZhou 负责技术落地搭建，毫无编程背景的人力同事 KithoZhou 主导产品构思 —— 两个上班爱摸鱼的人，用技术与巧思，为同样渴望改变的你而来。
...
Seize采用前后端分离的架构设计，基于 Wails 框架实现桌面应用开发：
...
UI/UX Design: 特别感谢 Kitho Zhou 的想法，她为Seize提供了专业、现代且极具易用性的视觉方案。
